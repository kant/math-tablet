...
import { NotebookChange, StyleObject, RelationshipObject, RelationshipRole } from '../../client/notebook';
import { NotebookChangeRequest, StyleChangeRequest } from '../../client/math-tablet-api';
